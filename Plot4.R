...
# Global Active Power
with(DataSubset, plot(dt, Global_active_power, type="l", xlab = "", ylab="Global Active Power"))
...
# Voltage
with(DataSubset, plot(dt, Voltage, type="l", xlab = "datetime"))

# Global Reactive Power
with(DataSubset, plot(dt, Global_reactive_power, type="l", xlab = "datetime"))
